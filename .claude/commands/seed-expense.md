...
- months -inteeger, how many past months to spread them across
...
in the users table. If not, stop and say: "No user found with id <user_id>."

## Step 3 - Generate and insert expenses 

Write and run a Python script that:

1. Spreads expenses randomly across the past <month> months

2. USes these categories with realistic Indain descriptions and amounts (rs):
- Food: 50-800
- Transport: 20-500
- Bills: 200-300
-Health: 100-200
